...
void init_arrays(char* corrcoef_filename, char* egm96_filename)
{int ig,i,n,m;double t1,t2;
 f_1=fopen(corrcoef_filename,"rb");/*correction coefficient file:
  modified with 'sed -e"s/D/e/g"' to be read with fscanf*/
 f_12=fopen(egm96_filename,"rb");/*potential coefficient file*/
